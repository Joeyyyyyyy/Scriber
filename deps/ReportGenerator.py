...
class ReportGenerator:
    def __init__(self,text):
        ...
        self.tags = {
            "Interaction", "Recording Ends","Recording ends","Short break", "Short Break","Short Break Initiated","Short Break initiated", "Short break initiated", "Short Break Starts", "Short Break starts",
               "Short break starts","Short Break Ends","Short Break Over", "Main Teaching","Main teaching", "Exercise",
            "Live Demonstration", "Story", "Screen Share",
            ...
            "Breakout Room Initiated","Breakout Room End", "Breakout Room end", "Breakout room end","Breakout room initiated", "Breakout Room initiated",
            ...
            "Breakout Rooms Initiated","Breakout Rooms End", "Breakout Rooms end", "Breakout rooms end","Breakout rooms initiated", "Breakout Rooms initiated",
